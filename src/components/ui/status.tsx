...
const statusVariants = cva(
  "inline-flex w-fit shrink-0 items-center gap-1.5 overflow-hidden whitespace-nowrap rounded-full border px-3 py-1.5 font-medium text-sm transition-colors",
  {
    variants: {
      variant: {
        default:
